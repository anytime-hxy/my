...
$.widget("ui.sortable", $.extend({}, $.ui.mouse, {
	...
	_createHelper: function(event) {
		...
		if(helper[0] == this.currentItem[0]){
			...
			//this._storedCSS = { width: this.currentItem[0].style.outterwidth, height: this.currentItem[0].style.height, position: this.currentItem.css("position"), top: this.currentItem.css("top"), left: this.currentItem.css("left") };
			this._storedCSS = { width: $(this.currentItem[0]).outerWidth(), height: $(this.currentItem[0]).outerHeight(), position: this.currentItem.css("position"), top: this.currentItem.css("top"), left: this.currentItem.css("left") };
        }

		//if(helper[0].style.width == '' || o.forceHelperSize) helper.width(this.currentItem.width());
		if(helper[0].style.width == '' || o.forceHelperSize) helper.width(this.currentItem.outerWidth());
		//if(helper[0].style.height == '' || o.forceHelperSize) helper.height(this.currentItem.height());
		if(helper[0].style.height == '' || o.forceHelperSize) helper.height(this.currentItem.outerHeight());
